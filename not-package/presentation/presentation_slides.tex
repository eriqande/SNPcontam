...
\centering
\includegraphics[width=.95\textwidth]{images/mixed_rho.pdf}
...
\begin{itemize}
   \item Next Steps: usse real output from a SNP genotyping platform
   \item Our statistical method has potential to provide new tool to advance SNP genotype use in fisheries management 
\end{itemize}
\end{frame}
