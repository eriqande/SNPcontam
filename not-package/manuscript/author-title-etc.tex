...
\newcommand{\myTitle}{Methods and software for detecting contaminated samples genotyped with SNPs for molecular ecology}

% redefine this to make author list. Note affiliation symbols are done manually.
% All caps tends to look better
\newcommand{\myAuthors}{ ELENA VENABLES$^{*}$, ANTHONY CLEMENTO, JOHN C. GARZA, and ERIC C.~ANDERSON$^{*,\dagger,\S}$}
